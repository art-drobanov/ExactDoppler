...
Public Class MotionExplorer
    ...
    Public Class MotionExplorerResult
        Public Property RGBMatrix As RGBMatrix
    ...
    Public Function ProcessWithBitmap(samples As Single(), samplesCount As Integer, lowFreq As Double, highFreq As Double,
        ...
        Return Process(samples, samplesCount, lowFreq, highFreq, deadZone, True, False, True, True, True)
    End Function
    ...
    Private Function Detect(result As MotionExplorerResult, mag As Double()(), zeroDbLevel As Double, deadZone As Integer,
        ...
        Dim magRGB = If(bitmapOutput, _paletteProcessor.Process(mag), Nothing)
